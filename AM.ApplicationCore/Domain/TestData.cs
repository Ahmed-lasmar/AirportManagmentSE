...
namespace AM.ApplicationCore.Domain
{
    internal class TestData
    {
        ...
        public static Flight flight6 = new Flight { FlightDate = new DateTime(2022, 05, 02, 20, 10, 10), Destination = "Lisbonne", EffectiveArrival = new DateTime(2022, 06, 01, 22, 30, 10), EstimatedDuration = 200, Plane = Airbusplane };
